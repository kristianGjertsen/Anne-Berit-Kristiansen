...
const flowers = [
  { left: -4, size: 25, angle: -22, drift: -260, lift: 0.66, depth: 1, offset: 0.09, delay: 0.00, bend: 62, mirror: false },
  { left: 6, size: 32, angle: 9, drift: -330, lift: 0.84, depth: 3, offset: -0.04, delay: 0.06, bend: 88, mirror: true },
  { left: 13, size: 22, angle: -14, drift: -270, lift: 0.72, depth: 1, offset: 0.14, delay: 0.02, bend: 68, mirror: false },
  { left: 21, size: 29, angle: 18, drift: -390, lift: 0.91, depth: 2, offset: 0.03, delay: 0.09, bend: 98, mirror: true },
  { left: 26, size: 24, angle: -7, drift: -310, lift: 0.69, depth: 1, offset: 0.16, delay: 0.04, bend: 76, mirror: false },
  { left: 34, size: 33, angle: 12, drift: -430, lift: 0.87, depth: 3, offset: -0.08, delay: 0.11, bend: 96, mirror: false },
  { left: 41, size: 23, angle: -19, drift: -360, lift: 0.74, depth: 2, offset: 0.11, delay: 0.03, bend: 64, mirror: true },
  { left: 46, size: 28, angle: 5, drift: -470, lift: 0.82, depth: 3, offset: 0.01, delay: 0.08, bend: 90, mirror: false },
  { left: 54, size: 31, angle: -9, drift: 460, lift: 0.89, depth: 2, offset: -0.05, delay: 0.05, bend: 95, mirror: true },
  { left: 60, size: 22, angle: 17, drift: 350, lift: 0.71, depth: 1, offset: 0.15, delay: 0.10, bend: 67, mirror: false },
  { left: 68, size: 30, angle: -16, drift: 420, lift: 0.85, depth: 3, offset: 0.02, delay: 0.02, bend: 100, mirror: true },
  { left: 73, size: 25, angle: 8, drift: 320, lift: 0.76, depth: 1, offset: 0.12, delay: 0.07, bend: 73, mirror: false },
  { left: 81, size: 33, angle: -5, drift: 370, lift: 0.92, depth: 3, offset: -0.07, delay: 0.12, bend: 89, mirror: true },
  { left: 89, size: 23, angle: 21, drift: 290, lift: 0.68, depth: 1, offset: 0.17, delay: 0.01, bend: 60, mirror: true },
  { left: 96, size: 28, angle: -12, drift: 330, lift: 0.81, depth: 2, offset: 0.04, delay: 0.08, bend: 94, mirror: false },
  { left: 104, size: 24, angle: 16, drift: 250, lift: 0.73, depth: 1, offset: 0.10, delay: 0.04, bend: 65, mirror: true },
]
